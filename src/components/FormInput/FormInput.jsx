...
const FormInput = ({field,toggleErrorOnKeyDown,delay}) => {
  return (
    <div style={{"--i":`${delay/5}s`}} className="form-div">
        ...
        : <textarea type="text" className={field.hasError ? "contact-textarea error-input" : "contact-textarea focus"} placeholder={field.category} name={field.category} autoComplete="off" />
}
